        ...
        <div class="container-fluid advertisement-four-container">
            <div class="row">
                @if ( isset($advertisementFour[0]))
                    <a href="http://142.93.214.21/mens" class="col-lg-6 col-12 no-padding" aria-label="Advertisement">
                        <img class="col-12 lazyload" data-src="{{ asset('/storage/' . $advertisementFour[0]) }}" alt="" />
                    </a>
                @endif

                <div class="col-lg-3 col-12 offers-ct-panel">
                    @if ( isset($advertisementFour[1]))
                        <a href="http://142.93.214.21/mens" class="row col-12 remove-padding-margin" aria-label="Advertisement">
                ...
                @if ( isset($advertisementFour[3]))
                    <a href="http://142.93.214.21/mens" class="col-lg-3 col-12 no-padding" aria-label="Advertisement">
...
@if (! $isRendered)
    <div class="container-fluid advertisement-four-container">
        <div class="row">
            <a href="http://142.93.214.21/mens" class="col-lg-4 col-12 no-padding" aria-label="Advertisement">
