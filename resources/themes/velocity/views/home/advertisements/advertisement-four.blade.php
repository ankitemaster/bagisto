        ...
        <div class="container-fluid advertisement-four-container">
            <div class="row">
                @if ( isset($advertisementFour[0]))
                    <a @if (isset($one)) href="# {{ $one }}" @endif class="col-lg-6 col-12 no-padding" aria-label="Advertisement">
                ...
                @if ( isset($advertisementFour[3]))
                    <a @if (isset($four)) href="{{ $four }}" @endif class="col-lg-3 col-12 no-padding" aria-label="Advertisement">
