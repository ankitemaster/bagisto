                ...
                <div class="row">
                    <div class="col-lg-8">
                        <ul class="checkout-steps">
                            <li>
                                ...
                                <div class="shipping-step-addresses">
                                    <div class="shipping-address-box active">
                                        ...
                                        <div class="address-box-action clearfix">
                                            <a href="checkout-shipping-2.html#" class="btn btn-sm btn-link">
                                                Edit
                                            </a>

                                            <a href="checkout-shipping-2.html#" class="btn btn-sm btn-outline-secondary float-right">
                                                Ship Here
                                            </a>
                                ...
                                <a href="checkout-shipping-2.html#" class="btn btn-sm btn-outline-secondary btn-new-address" data-toggle="modal" data-target="#addressModal">+ New Address</a>
                            </li>
                    ...
                    <div class="col-lg-4">
                        <div class="order-summary">
                            ...
                            <h4>
                                <a data-toggle="collapse" href="checkout-shipping-2.html#order-cart-section" class="collapsed" role="button" aria-expanded="false" aria-controls="order-cart-section">2 products in Cart</a>
                            </h4>
