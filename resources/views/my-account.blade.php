                ...
                <div class="row">
                    <div class="col-lg-9 order-lg-last dashboard-content">
                        ...
                        <form action="#">
                            ...
                            <div class="form-footer">
                                <a href="my-account.html#"><i class="icon-angle-double-left"></i>Back</a>
                    ...
                    <aside class="sidebar col-lg-3">
                        <div class="widget widget-dashboard">
                            ...
                            <ul class="list">
                                <li class="active"><a href="my-account.html#">Account Dashboard</a></li>
                                <li><a href="my-account.html#">Account Information</a></li>
                                <li><a href="my-account.html#">Address Book</a></li>
                                <li><a href="my-account.html#">My Orders</a></li>
                                <li><a href="my-account.html#">Billing Agreements</a></li>
                                <li><a href="my-account.html#">Recurring Profiles</a></li>
                                <li><a href="my-account.html#">My Product Reviews</a></li>
                                <li><a href="my-account.html#">My Tags</a></li>
                                <li><a href="my-account.html#">My Wishlist</a></li>
                                <li><a href="my-account.html#">My Applications</a></li>
                                <li><a href="my-account.html#">Newsletter Subscriptions</a></li>
                                <li><a href="my-account.html#">My Downloadable Products</a></li>
                            </ul>
                        </div><!-- End .widget -->
                    </aside><!-- End .col-lg-3 -->
                </div><!-- End .row -->
