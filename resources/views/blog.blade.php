                ...
                <nav class="toolbox toolbox-pagination">
                    <ul class="pagination">
                        <li class="page-item disabled">
                            <a class="page-link page-link-btn" href="blog.html#"><i class="icon-angle-left"></i></a>
                        </li>
                        ...
                        <li class="page-item"><a class="page-link" href="blog.html#">15</a></li>
                        <li class="page-item">
            ...
            <aside class="sidebar col-lg-3">
                <div class="sidebar-wrapper">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list">
                            <li><a href="blog.html#">All about clothing</a></li>
                            <li><a href="blog.html#">Make-up &amp; beauty</a></li>
                            <li><a href="blog.html#">Accessories</a></li>
                            <li><a href="blog.html#">Fashion trends</a></li>
                            <li><a href="blog.html#">Haircuts &amp; hairstyles</a></li>
                        </ul>
                    </div><!-- End .widget -->
