                        ...
                        <article class="entry single">
                            ...
                            <div class="entry-body">
                                ...
                                <div class="entry-meta">
                                    ...
                                    <span><i class="icon-user"></i>By <a href="single.html#">Admin</a></span>
                                    <span><i class="icon-folder-open"></i>
                                        <a href="single.html#">Haircuts & hairstyles</a>,
                                ...
                                <div class="entry-share">
                                    ...
                                    <div class="social-icons">
                                        <a href="single.html#" class="social-icon social-facebook" target="_blank" title="Facebook">
                                            <i class="icon-facebook"></i>
                                        </a>
                                        <a href="single.html#" class="social-icon social-twitter" target="_blank" title="Twitter">
                                            <i class="icon-twitter"></i>
                                        </a>
                                        <a href="single.html#" class="social-icon social-linkedin" target="_blank" title="Linkedin">
                                            <i class="icon-linkedin"></i>
                                        </a>
                                        <a href="single.html#" class="social-icon social-gplus" target="_blank" title="Google +">
                                            <i class="icon-gplus"></i>
                                        </a>
                                        <a href="single.html#" class="social-icon social-mail" target="_blank" title="Email">
                                ...
                                <div class="entry-author">
                                    ...
                                    <div class="author-content">
                                        <h4><a href="single.html#">John Doe</a></h4>
                    ...
                    <aside class="sidebar col-lg-3">
                        <div class="sidebar-wrapper">
                            ...
                            <div class="widget widget-categories">
                                ...
                                <ul class="list">
                                    <li><a href="single.html#">All about clothing</a></li>
                                    <li><a href="single.html#">Make-up &amp; beauty</a></li>
                                    <li><a href="single.html#">Accessories</a></li>
                                    <li><a href="single.html#">Fashion trends</a></li>
                                    <li><a href="single.html#">Haircuts &amp; hairstyles</a></li>
                                </ul>
                            </div><!-- End .widget -->
                            ...
                            <div class="widget">
                                ...
                                <ul class="list">
                                    <li><a href="single.html#">April 2018</a></li>
                                    <li><a href="single.html#">March 2018</a></li>
                                    <li><a href="single.html#">February 2018</a></li>
                                </ul>
                            </div><!-- End .widget -->
