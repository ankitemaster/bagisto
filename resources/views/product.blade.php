                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="product-single-details">
                                ...
                                <div class="product-filters-container">
                                    <div class="product-single-filter">
                                        ...
                                        <ul class="config-swatch-list">
                                            <li class="active">
                                                <a href="product.html#" style="background-color: #6085a5;"></a>
                                            </li>
                                            <li>
                                                <a href="product.html#" style="background-color: #ab6e6e;"></a>
                                            </li>
                                            <li>
                                                <a href="product.html#" style="background-color: #b19970;"></a>
                                            </li>
                                            <li>
                                                <a href="product.html#" style="background-color: #11426b;"></a>
                                            </li>
                                        </ul>
                                ...
                                <div class="product-action product-all-icons">
                                    ...
                                    <a href="product.html#" class="paction add-compare" title="Add to Compare">
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-action">
                            <a href="product.html#" class="btn-icon-wish"><i class="icon-heart"></i></a>
